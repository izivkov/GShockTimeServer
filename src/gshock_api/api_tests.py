...
async def run_api_tests():
    ...
    await gb5600_test(connection, device)
...
async def gb5600_test (connection, device):
    # await connection.ble_service_discovery(device)

    await connection.write_with_characteristic("00002a06-0000-1000-8000-00805f9b34fb", "00")
    await connection.write_with_characteristic("26eb000f-b012-49a8-b1f8-394fb2032b0f", "FFD5555751482C01020000")    
