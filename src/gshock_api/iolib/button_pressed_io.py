    ...
    def on_received(data):
        ...
        def button_pressed_callback(data):
            ...
            if len(data) >= 19:
                ...
                ret = (
                    WatchButton.LOWER_LEFT if (button_indicator == 0 or button_indicator == 1)
                    else WatchButton.FIND if button_indicator == 2
                    else WatchButton.LOWER_RIGHT if button_indicator == 4
                    else WatchButton.NO_BUTTON if button_indicator == 3
